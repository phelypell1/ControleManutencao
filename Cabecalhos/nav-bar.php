<?php
  ...
  require_once('../Connections/ConexaoUser.php');
      ...
      $codigo = mysqli_query($link, $query);

      if($codigo){
        while($version = mysqli_fetch_array($codigo)){
...
<div class="footer center">
  <div class="row">
  <p class="col" >Versão: <?echo$versao?></p>
  <p class="col">Desenvolvido por: CaveiraDev</p>
  <p class="col">Todos os direitos reservados <img src="../imagens/c-copyright-png-1.png" width="16"></p>
